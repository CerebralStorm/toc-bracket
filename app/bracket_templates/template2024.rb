class Template2024
  ...
  def create_bracket
    ...
    create_region('West A', [west_a1, west_a2, west_a3, west_a4])
    ...
    create_region('West B', [west_b1, west_b2, west_b3, west_b4])
    ...
    create_region('East A', [east_a1, east_a2, east_a3, east_a4])
    ...
    create_region('East B', [east_b1, east_b2, east_b3, east_b4])
  end

  def create_region(region_name, matches)
    ...
    matches.each do |chefs|
      ...
      chefs.each do |chef|
        ...
        matchup_chef.update(seed: chef[:seed], region: region_name)
      end
    end
  end
end